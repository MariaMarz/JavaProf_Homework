...
public class ArrayWorking2 {
        ...
        private double[] array =  new double[5];      //  Массив, в который пишем данные
        ...
        public void add(double data){
            ...
            if(count == array.length){            // Проверяем не закончилась ли память
                double[] temp = array;// Копируем массив во временный массив
                array = new double[2 * array.length]; // Выделяем в два раза больше памяти
